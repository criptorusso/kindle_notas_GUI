...
while True:
	...
	if event == 'Autores':
		...
		sg.PopupScrolled(text, size=(70,20), title='Autores', location=(100,100))    
		...
		sg.PopupScrolled(text, size=(100,20), title='Libros', location=(100,100))
		...
		if key_word != "":		
			...
			if text != '':			
				sg.PopupScrolled(text, size=(100,20), title=values[0], location=(100,100))
